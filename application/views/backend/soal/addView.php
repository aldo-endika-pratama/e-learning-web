        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box">
                        ...
                        <h4 class="page-title">Tambah Soal Quiz</h4>
                    </div>
                </div>
            </div>
            <!-- end page title -->
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="header-title">Form Tambah Soal Quiz</h4>
                                ...
                                <div class="row">
                                    <div class="col-md">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" name="soalQuiz" id="soalQuiz" cols="30" rows="7"></textarea>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6">
                                                <div class="radio radio-success mb-2">
                                                    <input type="radio" name="jawaban" value="option_1" id="customradio1">
                                                    <label for="customradio1">Option 1</label>
                                                </div>
                                                <div class="radio radio-success mb-2">
                                                    <input type="radio" name="jawaban" value="option_2" id="customradio2">
                                                    <label for="customradio2">Option 2</label>
                                                </div>
                                            </div>
                                            <div class="col-sm-6">
                                                <div class="radio radio-success mb-2">
                                                    <input type="radio" name="jawaban" value="option_3" id="customradio3">
                                                    <label for="customradio3">Option 3</label>
                                                </div>
                                                <div class="radio radio-success mb-2">
                                                    <input type="radio" name="jawaban" value="option_4" id="customradio4">
