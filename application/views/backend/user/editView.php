                                ...
                                <div class="row">
                                    <div class="col-lg-5">
                                        <div class="mb-3">
                                            ...
                                            <input value="<?= $user['first_name'] ?>" type="text" name="firstName" id="firstName" class="form-control">
                                    ...
                                    <div class="col-lg-5">
                                        <div class="mb-3">
                                            ...
                                            <input value="<?= $user['last_name'] ?>" type="text" name="lastName" id="lastName" class="form-control">
                                    ...
                                    <div class="col-lg-2">
                                        <div class="mb-3">
                                            ...
                                            <div class="radio radio-success mb-2">
                                                <input <?= $user['gender'] == 'L' ? 'checked' : '' ?> type="radio" name="jenisKelamin" value="L" id="customradio1">
                                                <label for="customradio1">Laki - Laki</label>
                                            </div>
                                            <div class="radio radio-success mb-2">
                                                <input <?= $user['gender'] == 'P' ? 'checked' : '' ?> type="radio" name="jenisKelamin" value="P" id="customradio2">
                                ...
                                <div class="row">
                                    <div class="col-lg-4">
                                        <div class="mb-3">
                                            ...
                                            <input value="<?= $user['user_name'] ?>" type="text" name="username" id="option3" class="form-control">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="mb-3">
                                            <label class="form-label">Password Baru <span class="text-danger">* (Kosongkan Saja jika tidak mengganti password)</span></label>
                                            <input type="text" name="passwordBaru" id="option4" class="form-control">
                                    ...
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            ...
                                            <select id="role" name="role" class="form-control" data-toggle="select2">
                                                ...
                                                <option <?= $user['user_role'] == 1 ? 'selected' : '' ?> value="1">Administrator</option>
                                                <option <?= $user['user_role'] == 0 ? 'selected' : '' ?> value="0">User/Pengguna</option>
                                            </select>
